...
public class AuthService {
        ...
        @org.springframework.beans.factory.annotation.Value("${app.security.max-failed-login-attempts:5}")
        private int maxFailedAttempts;

        @org.springframework.beans.factory.annotation.Value("${app.security.account-lockout-duration-minutes:30}")
        ...
        private void handleLoginFailure(User user) {
                ...
                if (user.getFailedLoginCount() >= maxFailedAttempts) {
                        ...
                        log.warn("🔒 Account LOCKED for user {}: too many failed attempts ({})",
        ...
        public LoginResponse login(LoginRequest request) {
                ...
                if (user.isLocked()) {
                        log.error("Locked account attempted login: {}", user.getEmail());
        ...
        public void resetPassword(String email, String otp, String newPassword) {
                ...
                PasswordResetToken token = passwordResetTokenRepository.findByToken(otp)
                                .orElseThrow(() -> new IllegalArgumentException("Invalid OTP")); // Generic message for
                                                                                                 // security

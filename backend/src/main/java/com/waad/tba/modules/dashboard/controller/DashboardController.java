...
public class DashboardController {
     ...
     */
    @GetMapping("/summary")
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasRole('INSURANCE_ADMIN') or hasRole('EMPLOYER_ADMIN') or hasAuthority('VIEW_REPORTS')")
    @Operation(
    ...
    public ResponseEntity<ApiResponse<List<CostByProviderDto>>> getCostsByProvider(
        ...
        List<CostByProviderDto> costs = service.getCostsByProvider(limit);
    ...
    public ResponseEntity<ApiResponse<List<ServiceDistributionDto>>> getServiceDistribution() {
        List<ServiceDistributionDto> distribution = service.getServiceDistribution();

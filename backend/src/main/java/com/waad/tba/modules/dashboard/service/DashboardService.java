...
public class DashboardService {
        ...
        private final com.waad.tba.common.repository.OrganizationRepository organizationRepository;
        ...
        public DashboardSummaryDto getSummary(Long employerId) {
                ...
                // Count organizations
                // Providers are managed via ProviderRepository.
                long totalProviders = providerRepository.count();
                long activeProviders = providerRepository.countActiveProviders();

                // Count employers and insurers from organizationRepository
                // Since organizations table now ONLY contains employers.
                long totalEmployers = organizationRepository.count();
                long totalInsuranceCos = 0; // Legacy FIELD - will be moved to its own table later
                ...
                log.debug(
                                "📊 Dashboard Summary"
                                                + (employerId != null ? " (Employer " + employerId + ")" : " (All)")
                                                + " - Members: {}/{}, Providers: {}/{}",
                ...
                return DashboardSummaryDto.builder()
                                ...
                                .totalInsurers(totalInsuranceCos)
                                .totalMedicalCost(totalMedicalCost)
         ...
         * Aggregated by provider name (since service type/name not available in Claim
         * entity)
         * 
                ...
                return results.stream()
                                .map(row -> {
                                        ...
                                        return ServiceDistributionDto.builder()
                                                        .serviceType(providerName) // Using provider name as service
                                                                                   // type
        ...
        public List<RecentActivityDto> getRecentActivities(int limit) {
                ...
                if (authorizationService.isProvider(currentUser)) {
                        Long providerId = currentUser.getProviderId();
                        if (providerId != null) {
                                log.debug("📊 Fetching recent activities for PROVIDER {} (limit: {})", providerId,
                                                limit);
                                Pageable pageable = PageRequest.of(0, limit);
                                List<Object[]> recentClaims = claimRepository.getRecentClaimsByProvider(providerId,
                                                pageable);
        ...
        private BigDecimal calculateMonthlyGrowth(Long employerId) {
                try {
                        ...
                        long currentMonthCount = employerId != null
                                        ? memberRepository.countMembersInDateRangeByEmployer(currentMonthStart,
                                                        currentMonthEnd, employerId)
                                        : memberRepository.countMembersInDateRange(currentMonthStart, currentMonthEnd);

                        long previousMonthCount = employerId != null
                                        ? memberRepository.countMembersInDateRangeByEmployer(previousMonthStart,
                                                        previousMonthEnd,
                                                        employerId)
                                        : memberRepository.countMembersInDateRange(previousMonthStart,
                                                        previousMonthEnd);
                        ...
                        double growth = ((double) (currentMonthCount - previousMonthCount) / previousMonthCount)
                                        * 100.0;
        ...
        private DashboardStatsDto getGlobalStats() {
                ...
                long totalEmployers = organizationRepository.count();
                long totalInsuranceCos = 0;
                long totalReviewerCos = 0;
                ...
                return DashboardStatsDto.builder()
                                ...
                                .totalEmployers(totalEmployers)
                                .totalInsuranceCompanies(totalInsuranceCos)
                                .totalReviewerCompanies(totalReviewerCos)
                                .build();
        }

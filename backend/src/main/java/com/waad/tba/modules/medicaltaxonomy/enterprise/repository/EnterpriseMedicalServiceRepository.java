...
@Repository
public interface EnterpriseMedicalServiceRepository extends JpaRepository<EnterpriseMedicalService, Long> {
    ...
    org.springframework.data.domain.Page<EnterpriseMedicalService> searchActive(

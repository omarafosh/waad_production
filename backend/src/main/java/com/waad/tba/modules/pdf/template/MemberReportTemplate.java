package com.waad.tba.modules.pdf.template;

import com.lowagie.text.*;
import com.lowagie.text.pdf.PdfPTable;
import com.waad.tba.modules.member.dto.MemberResponseDto;
import com.waad.tba.modules.pdf.service.PdfTableBuilder;
    ...
    public List<Element> generateMemberListReport(List<MemberResponseDto> members) {
        ...
        try {
            ...
            for (MemberResponseDto member : members) {
                ...
                memberData.add(new PdfTableBuilder.KeyValue("الهوية / Civil ID", member.getCivilId()));

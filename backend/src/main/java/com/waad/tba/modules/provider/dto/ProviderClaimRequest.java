...
public class ProviderClaimRequest {
    ...
    @Schema(description = "Visit ID (claim must be linked to a visit)", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Member ID (principal or dependent)", example = "123", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Claim type", example = "DIRECT_BILLING", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = {
            "CASH", "DIRECT_BILLING" })
    ...
    @Schema(description = "Service type", example = "OUTPATIENT", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = {
    ...
    @Schema(description = "Service date", example = "2026-01-11", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Service name/description", example = "General Consultation", requiredMode = Schema.RequiredMode.REQUIRED)
    private String serviceName;

    /**
     * Diagnosis - ICD code or description (LEGACY - use
    ...
    @Schema(description = "Claimed amount (LYD)", example = "150.00", requiredMode = Schema.RequiredMode.REQUIRED)

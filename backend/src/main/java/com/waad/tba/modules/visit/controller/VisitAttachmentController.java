...
public class VisitAttachmentController {
    ...
    @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'INSURANCE_ADMIN') or hasAnyAuthority('VISIT_CREATE', 'VISIT_UPDATE')")
    ...
    @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'INSURANCE_ADMIN') or hasAuthority('VISIT_VIEW')")
    ...
    @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'INSURANCE_ADMIN') or hasAnyAuthority('VISIT_UPDATE', 'VISIT_DELETE')")

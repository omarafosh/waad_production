...
public class ProviderContextGuard {
    ...
    public boolean canCreateForProvider(Long targetProviderId) {
        ...
        // ADMIN users (SUPER and INSURANCE) can create for any provider
        if (authorizationService.isAdmin(currentUser)) {
            return true;
        }
    ...
    public Long getProviderFilter() {
        ...
        // Admin privileges (SUPER and INSURANCE) see all data
        if (authorizationService.isAdmin(currentUser)) {
            return null;
        }
    ...
    public boolean isCurrentUserAdmin() {
        User currentUser = authorizationService.getCurrentUser();
        return currentUser != null && authorizationService.isAdmin(currentUser);
    }
}

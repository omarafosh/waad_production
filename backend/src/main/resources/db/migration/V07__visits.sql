...
-- 4. PRICING IMPORT LOGS (Added 2026-02-17)
...
CREATE INDEX IF NOT EXISTS idx_pricing_import_batch ON pricing_import_logs(import_batch_id);
CREATE INDEX IF NOT EXISTS idx_pricing_import_contract ON pricing_import_logs(contract_id);

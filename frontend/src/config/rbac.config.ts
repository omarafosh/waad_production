 ...
 * 
 * @param {MenuItem[]} menuItems - Full menu structure
 * @param {User} user - User object { roles, permissions }
  ...
  const filterRecursive = (items: MenuItem[]): MenuItem[] => {
    return items
      .map(item => {
        ...
        let filteredChildren: MenuItem[] | null = null;
        if (item.children) {
 ...
 */
export const MENU_PERMISSIONS: Record<string, string | string[] | null> = {
  // 📊 DASHBOARD
  'dashboard': null,
 ...
 * ═══════════════════════════════════════════════════════════════════════════
 */
export const hasMenuPermission = (user: User | null | undefined, menuId: string): boolean => {
 ...
 * ═══════════════════════════════════════════════════════════════════════════
 */
export const canAccessRoute = (user: User | null | undefined, path: string): boolean => {
  // SUPER_ADMIN bypass

...
export const PERMISSIONS = Object.freeze({
  ...
  CLAIM_REVIEW_START: 'CLAIM_REVIEW_START',
  CLAIM_APPROVE: 'CLAIM_APPROVE',
  CLAIM_REJECT: 'CLAIM_REJECT',
  CLAIM_SETTLE: 'CLAIM_SETTLE',
  CLAIM_FAST_SETTLE: 'CLAIM_FAST_SETTLE',
  CLAIM_FINANCIAL_VIEW: 'CLAIM_FINANCIAL_VIEW',
  CLAIM_ATTACHMENT_UPLOAD: 'CLAIM_ATTACHMENT_UPLOAD',
  CLAIM_ATTACHMENT_DOWNLOAD: 'CLAIM_ATTACHMENT_DOWNLOAD',
  ...
  PREAUTH_REVIEW_START: 'PREAUTH_REVIEW_START',

  // --- Members ---
  MEMBER_VIEW: 'MEMBER_VIEW',
  MEMBER_CREATE: 'MEMBER_CREATE',
  MEMBER_UPDATE: 'MEMBER_UPDATE',
  MEMBER_EDIT: 'MEMBER_UPDATE', // Alias
  MEMBER_DELETE: 'MEMBER_DELETE',
  MEMBER_SUSPEND: 'MEMBER_SUSPEND',
  MEMBER_ACTIVATE: 'MEMBER_ACTIVATE',
  MEMBER_TERMINATE: 'MEMBER_TERMINATE',
  MEMBER_EXCEL_IMPORT: 'MEMBER_EXCEL_IMPORT',
  MEMBER_IMPORT: 'MEMBER_EXCEL_IMPORT', // Alias
  MEMBER_PDF_EXPORT: 'MEMBER_PDF_EXPORT',
  MEMBER_EXPORT: 'MEMBER_PDF_EXPORT', // Alias
  MEMBER_CARD_GENERATE: 'MEMBER_CARD_GENERATE',

  // --- Providers ---
  PROVIDER_VIEW: 'PROVIDER_VIEW',
  PROVIDER_CREATE: 'PROVIDER_CREATE',
  PROVIDER_UPDATE: 'PROVIDER_UPDATE',
  PROVIDER_EDIT: 'PROVIDER_UPDATE', // Alias
  PROVIDER_DELETE: 'PROVIDER_DELETE',
  PROVIDER_CONTRACT_MANAGE: 'PROVIDER_CONTRACT_MANAGE',
  PROVIDER_DOC_DOWNLOAD: 'PROVIDER_DOC_DOWNLOAD',

  // --- Employers ---
  EMPLOYER_VIEW: 'EMPLOYER_VIEW',
  EMPLOYER_CREATE: 'EMPLOYER_CREATE',
  EMPLOYER_UPDATE: 'EMPLOYER_UPDATE',
  EMPLOYER_EDIT: 'EMPLOYER_UPDATE', // Alias
  EMPLOYER_DELETE: 'EMPLOYER_DELETE',
  EMPLOYER_ARCHIVE: 'EMPLOYER_ARCHIVE',
...
export const PERMISSION_GROUPS = Object.freeze({
  TPA_ADMIN: [
    ...
    'PROVIDER_VIEW', 'EMPLOYER_VIEW'
  ],
  MEDICAL_OPS: [
    'CLAIM_VIEW', 'CLAIM_REVIEW_START', 'CLAIM_APPROVE', 'CLAIM_REJECT',
    'PREAUTH_VIEW', 'PREAUTH_REVIEW_START', 'PREAUTH_APPROVE', 'PREAUTH_REJECT'
  ],
  FINANCIAL_OPS: [
    'CLAIM_VIEW', 'CLAIM_FINANCIAL_VIEW', 'CLAIM_SETTLE', 'CLAIM_FAST_SETTLE',
    'ANALYTICS_VIEW'
  ]
});
...
export const ROLE_PERMISSIONS = Object.freeze({
  [SystemRole.SUPER_ADMIN]: Object.values(PERMISSIONS),

  [SystemRole.INSURANCE_ADMIN]: [
    ...Object.values(PERMISSIONS).filter(p => p !== 'RBAC_MANAGE' && p !== 'SYSTEM_SETTINGS')
  ],

  [SystemRole.MEDICAL_REVIEWER]: [
    'CLAIM_VIEW', 'CLAIM_REVIEW_START', 'CLAIM_APPROVE', 'CLAIM_REJECT', 'CLAIM_FINANCIAL_VIEW',
    'PREAUTH_VIEW', 'PREAUTH_REVIEW_START', 'PREAUTH_APPROVE', 'PREAUTH_REJECT',
    'MEMBER_VIEW'
  ],
  ...
  [SystemRole.PROVIDER]: [
    'CLAIM_VIEW', 'CLAIM_CREATE', 'CLAIM_UPDATE', 'CLAIM_ATTACHMENT_UPLOAD',
    'PREAUTH_VIEW', 'PREAUTH_CREATE',
    'MEMBER_VIEW', 'MEMBER_CARD_GENERATE',
    'DASHBOARD_VIEW'
  ],

  [SystemRole.EMPLOYER_ADMIN]: [
    'MEMBER_VIEW', 'MEMBER_CREATE', 'MEMBER_UPDATE', 'MEMBER_PDF_EXPORT',
    'CLAIM_VIEW', 'CLAIM_FINANCIAL_VIEW',
    'ANALYTICS_VIEW'
  ]
});

...
export interface TableRefreshContextType {
  refreshKey: number;
  triggerRefresh: () => void;
}

const TableRefreshContext = createContext<TableRefreshContextType | null>(null);

// ============================================================================
// PROVIDER (for wrapping components manually)
// ============================================================================

export interface TableRefreshProviderProps {
  children: ReactNode;
}
 ...
 */
export const TableRefreshProvider: React.FC<TableRefreshProviderProps> = ({ children }) => {
 ...
 */
export const TableRefreshLayout: React.FC = () => {
 ...
 * @returns {TableRefreshContextType}
 */
export const useTableRefresh = (): TableRefreshContextType => {
  const context = useContext(TableRefreshContext);

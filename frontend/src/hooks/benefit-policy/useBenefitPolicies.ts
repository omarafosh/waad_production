...
export interface BenefitPoliciesParams {
  page?: number;
  size?: number;
  sortBy?: string;
  sortDir?: string;
...
export interface BenefitPoliciesListHook {
  data: any;
  loading: boolean;
  error: any;
  refresh: () => void;
 ...
 */
export const useBenefitPoliciesList = (params: BenefitPoliciesParams = {}): BenefitPoliciesListHook => {
...
export interface BenefitPolicyDetailsHook {
  data: any;
  loading: boolean;
  error: any;
  refresh: () => void;
 ...
 * @returns {Object} { data, loading, error, refresh }
 */
export const useBenefitPolicyDetails = (id: number | string | null): BenefitPolicyDetailsHook => {
  const [data, setData] = useState<any>(null);
  const [loading, setLoading] = useState<boolean>(true);
  const [error, setError] = useState<any>(null);
...
export interface BenefitPolicySelectorHook {
  data: any[];
  loading: boolean;
  error: any;
  refresh: () => void;
 ...
 * @returns {Object} { data, loading, error, refresh }
 */
export const useBenefitPolicySelector = (): BenefitPolicySelectorHook => {
 ...
 * @returns {Object} { data, loading, error, refresh }
 */
export const useBenefitPolicySelectorByEmployer = (employerId: number | string | null): BenefitPolicySelectorHook => {
  const [data, setData] = useState<any[]>([]);
  const [loading, setLoading] = useState<boolean>(true);
  const [error, setError] = useState<any>(null);

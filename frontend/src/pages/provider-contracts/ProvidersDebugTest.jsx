        ...
        {data && (
          <Box sx={{ mt: 3 }}>
            ...
            <Paper sx={{ p: 2 }}>
              ...
              {Array.isArray(data) && (
                <Typography>• Array Length: {data.length}</Typography>
              )}
              
              {data?.content && (
                <Typography>• content.length: {data.content.length}</Typography>
              )}
              
              {data?.data && (
                <Typography>• data.length: {Array.isArray(data.data) ? data.data.length : 'Not an array'}</Typography>
              )}

...
export const SERVICE_CATEGORIES = [
  { id: 1, code: 'CONS', nameAr: 'استشارات طبية', nameEn: 'Consultations' },
  { id: 2, code: 'LAB', nameAr: 'تحاليل مخبرية', nameEn: 'Laboratory' },
  { id: 3, code: 'RAD', nameAr: 'أشعة تشخيصية', nameEn: 'Radiology' },
  { id: 4, code: 'SURG', nameAr: 'عمليات جراحية', nameEn: 'Surgery' },
  { id: 5, code: 'PHARM', nameAr: 'أدوية', nameEn: 'Pharmacy' },
  { id: 6, code: 'DENT', nameAr: 'علاج أسنان', nameEn: 'Dental' },
  { id: 7, code: 'OPT', nameAr: 'بصريات', nameEn: 'Optical' },
  { id: 8, code: 'PHYS', nameAr: 'علاج طبيعي', nameEn: 'Physiotherapy' },
  { id: 9, code: 'EMER', nameAr: 'طوارئ', nameEn: 'Emergency' },
  { id: 10, code: 'INP', nameAr: 'إقامة', nameEn: 'Inpatient' }
];
...
const MOCK_PROVIDERS = [
  { id: 1, code: 'PRV-001', nameAr: 'مستشفى طرابلس المركزي', nameEn: 'Tripoli Central Hospital', type: 'HOSPITAL', city: 'طرابلس' },
  { id: 2, code: 'PRV-002', nameAr: 'مركز بنغازي الطبي', nameEn: 'Benghazi Medical Center', type: 'HOSPITAL', city: 'بنغازي' },
  { id: 3, code: 'PRV-003', nameAr: 'عيادة السلامة', nameEn: 'Al-Salama Clinic', type: 'CLINIC', city: 'طرابلس' },
  { id: 4, code: 'PRV-004', nameAr: 'مختبرات الحياة', nameEn: 'Al-Hayat Labs', type: 'LABORATORY', city: 'طرابلس' },
  { id: 5, code: 'PRV-005', nameAr: 'صيدلية الشفاء', nameEn: 'Al-Shifaa Pharmacy', type: 'PHARMACY', city: 'مصراتة' },
  { id: 6, code: 'PRV-006', nameAr: 'مركز النور للأشعة', nameEn: 'Al-Noor Radiology', type: 'DIAGNOSTIC_CENTER', city: 'طرابلس' },
  { id: 7, code: 'PRV-007', nameAr: 'مستشفى الأمل الخاص', nameEn: 'Al-Amal Private Hospital', type: 'HOSPITAL', city: 'سبها' },
  { id: 8, code: 'PRV-008', nameAr: 'عيادة أسنان الابتسامة', nameEn: 'Smile Dental Clinic', type: 'DENTAL_CLINIC', city: 'طرابلس' }
];
  ...
  if (search) {
    ...
    filtered = filtered.filter(
      (c) =>
        ...
        c.provider.nameAr.includes(search) ||
        c.provider.nameEn.toLowerCase().includes(searchLower)
    );
  }

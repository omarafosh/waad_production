...
type ProviderSettlementReportParams = {
  startDate?: string;
  endDate?: string;
};
...
export const claimsService = {
   ...
   */
  getAll: async (params: ClaimsListParams = {}) => {
    try {
      const queryParams = new URLSearchParams();
      if (params.page !== undefined) queryParams.append('page', String(params.page));
      if (params.size !== undefined) queryParams.append('size', String(params.size));
      if (params.employerId !== undefined) queryParams.append('employerId', String(params.employerId));
      if (params.sort) {
   ...
   */
  getPendingClaims: async (params: InboxClaimsParams = {}) => {
    try {
      const queryParams = new URLSearchParams();
      if (params.page !== undefined) queryParams.append('page', String(params.page));
      if (params.size !== undefined) queryParams.append('size', String(params.size));
   ...
   */
  getPendingClaimsStats: async () => {
    try {
      const response = await axiosClient.get(`${BASE_URL}/inbox/pending/stats`);
      return unwrap(response);
    } catch (error) {
      throw handleClaimErrors(error);
    }
   ...
   */
  getApprovedClaims: async (params: InboxClaimsParams = {}) => {
    try {
      const queryParams = new URLSearchParams();
      if (params.page !== undefined) queryParams.append('page', String(params.page));
      if (params.size !== undefined) queryParams.append('size', String(params.size));
   ...
   */
  getAdjudicationReport: async (params: AdjudicationReportParams = {}) => {
    try {
      const queryParams = new URLSearchParams();
   ...
   */
  getProviderSettlementReport: async (providerId, params: ProviderSettlementReportParams = {}) => {
    try {
   ...
   */
  getFinancialSummary: async (params: FinancialSummaryParams = {}) => {
    try {
      const queryParams = new URLSearchParams();
      if (params.employerOrgId !== undefined) queryParams.append('employerOrgId', String(params.employerOrgId));
   ...
   */
  getSettlementSummary: async (params: Pick<FinancialSummaryParams, 'employerOrgId'> = {}) => {
    try {
      const queryParams = new URLSearchParams();
      if (params.employerOrgId !== undefined) queryParams.append('employerOrgId', String(params.employerOrgId));

 ...
 */
export const exportMembersPdf = async (params: MemberListParams = {}) => {
 ...
 */
export const searchForEligibility = async (params: EligibilitySearchParams = {}) => {
  try {
 ...
 */
export const findOneForEligibility = async (params: EligibilitySearchParams = {}) => {
 ...
 * @deprecated Use searchForEligibility instead - clearer naming
 */
export const unifiedSearchMembers = async (params: EligibilitySearchParams = {}) => {
...
export const advancedSearchMembers = async (searchType, searchValue, employerId = null) => {
  const params: { searchType: any; searchValue: any; employerId?: number } = { searchType, searchValue };
  if (employerId) {
 ...
 */
export const getImportLogs = async (params: ImportLogParams = {}) => {
 ...
 * @returns {Promise<Blob>} PDF file blob
 */
export const exportMemberCardPdf = async (id, params: MemberCardExportParams = {}) => {

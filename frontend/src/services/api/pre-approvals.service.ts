...
export const preApprovalsService = {
   ...
   */
  getAll: async (params: PreApprovalListParams = {}) => {
    try {
      const queryParams = new URLSearchParams();
      if (params.page !== undefined) queryParams.append('page', String(params.page - 1)); // Backend is 0-indexed
   ...
   */
  getPending: async (params: PreApprovalListParams = {}) => {
    try {
      const queryParams = new URLSearchParams();

...
/**
 * Mapping between relationships and expected gender
 */
export const RELATIONSHIP_GENDER_MAP = {
  WIFE: GENDERS.FEMALE,
  HUSBAND: GENDERS.MALE,
  SON: GENDERS.MALE,
  DAUGHTER: GENDERS.FEMALE,
  FATHER: GENDERS.MALE,
  MOTHER: GENDERS.FEMALE,
  BROTHER: GENDERS.MALE,
  SISTER: GENDERS.FEMALE
};

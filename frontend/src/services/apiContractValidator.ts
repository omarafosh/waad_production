...
type SchemaType = 'string' | 'number' | 'boolean' | 'array' | 'object' | string;

interface SchemaObject {
  [key: string]: SchemaType | SchemaObject;
}

type Schema = SchemaType | SchemaObject;
...
type ValidatorFn = (v: any) => boolean;

const typeValidators: Record<string, ValidatorFn> = {
  'string': (v: any) => typeof v === 'string',
  'string?': (v: any) => v === null || v === undefined || typeof v === 'string',
  'number': (v: any) => typeof v === 'number' && !isNaN(v),
  'number?': (v: any) => v === null || v === undefined || (typeof v === 'number' && !isNaN(v)),
  'boolean': (v: any) => typeof v === 'boolean',
  'boolean?': (v: any) => v === null || v === undefined || typeof v === 'boolean',
  'array': (v: any) => Array.isArray(v),
  'array?': (v: any) => v === null || v === undefined || Array.isArray(v),
  'object': (v: any) => v !== null && typeof v === 'object' && !Array.isArray(v),
  'object?': (v: any) => v === null || v === undefined || (typeof v === 'object' && !Array.isArray(v))
};
 ...
 */
const validateValue = (value: any, schema: Schema, path: string = 'root'): string[] => {
  const errors: string[] = [];
  ...
  if (typeof schema === 'string') {
    ...
    if (validator) {
        ...
        // Unknown type validator (e.g. 'string?') when not in map?
        // Actually our map covers most. If not found, skip or warn?
        // For now, assuming map covers all used types.
    }
    return errors;
  }
  ...
  if (typeof schema === 'object' && schema !== null) {
    ...
    for (const [key, fieldSchema] of Object.entries(schema)) {
      ...
      if (fieldValue === undefined && !isOptional) {
        ...
        errors.push(...validateValue(fieldValue, fieldSchema as Schema, fieldPath));
      }
    }
  }
 ...
 */
const getContractKey = (url?: string): string | null => {
  if (!url) return null;
 ...
 */
const getSchemaForResponse = (contract: any, response: any): Schema | null => {
 ...
 */
export const validateApiResponse = (url?: string, response?: any): ValidationResult => {

...
export interface ApiErrorResponse {
  ...
  fieldErrors: Record<string, any> | null;
  originalError: any;
}
 ...
 */
export const handleApiError = (error: any, customMessages: CustomMessages = {}, entityName: string = 'العنصر'): ApiErrorResponse => {
 ...
 */
export const createErrorHandler = (entityName: string, customMessages: CustomMessages = {}) => {
  return (error: any) => handleApiError(error, customMessages, entityName);
};
 ...
 */
export const mapFieldErrors = (fieldErrors: Record<string, any>, fieldMapping: Record<string, string> = {}) => {
 ...
 */
export const extractFieldErrors = (errorResponse: ApiErrorResponse) => {
 ...
 */
export const isValidationError = (errorResponse: ApiErrorResponse) => {
 ...
 */
export const isAuthError = (errorResponse: ApiErrorResponse) => {
  const status = errorResponse?.status;
 ...
 */
export const isNotFoundError = (errorResponse: ApiErrorResponse) => {
 ...
 */
export const isConflictError = (errorResponse: ApiErrorResponse) => {
 ...
 */
export const isServerError = (errorResponse: ApiErrorResponse) => {
  const status = errorResponse?.status;
  return status >= 500;
};

import { getNumberLocale, getAppLocale } from './locale-helper';

export const formatCurrency = (amount: number | null | undefined, locale: string = getNumberLocale()): string => {
 ...
 */
export const formatNumber = (amount: number | null | undefined, locale: string = getAppLocale()): string => {
  if (amount === null || amount === undefined || isNaN(amount)) {
    return '0.000';
  }

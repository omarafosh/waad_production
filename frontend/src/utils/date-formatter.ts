...
export const formatDate = (date: string | Date | null | undefined, format: DateFormat = 'medium'): string => {
  if (!date) return '-';
 ...
 */
export const formatDateTime = (datetime: string | Date | null | undefined, includeSeconds: boolean = false): string => {
  if (!datetime) return '-';
 ...
 */
export const formatTime = (datetime: string | Date | null | undefined, includeSeconds: boolean = false): string => {
  if (!datetime) return '-';

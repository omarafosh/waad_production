 ...
 */
export const exportToExcel = (data: any[], filename: string = 'export', options: ExportOptions = {}): void => {
 ...
 * 
 * @param {any} arg1 - Data array or columns array
 * @param {any} arg2 - Title string or rows array
 * @param {any} arg3 - Filename string or title string
 * @param {any} arg4 - Options object or filename string
 * @param {any} arg5 - Options object (if signature 2)
 */
export const exportToPDF = (arg1: any, arg2?: any, arg3?: any, arg4?: any, arg5?: any): void => {
  let columns: string[], rows: any[][], title: string, filename: string, options: ExportOptions;

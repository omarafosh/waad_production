 ...
 */
export const suppressMUIDeprecationWarnings = (): void => {
 ...
 * 
 * @param {GridV1Props} v1Props - Grid v1 props { xs, sm, md, lg, xl }
 * @returns {object | undefined} Grid v2 size prop object
 * 
 * @example
 * convertToV2Size({ xs: 12, sm: 6, md: 4 })
 * // Returns: { xs: 12, sm: 6, md: 4 }
 */
export const convertToV2Size = ({ xs, sm, md, lg, xl }: GridV1Props): Record<string, any> | undefined => {
...
export interface SafeGridProps extends GridV1Props {
  item?: boolean;
  size?: any;
  [key: string]: any;
}
 ...
 */
export const SafeGrid = ({ item, xs, sm, md, lg, xl, size, ...rest }: SafeGridProps): any => {

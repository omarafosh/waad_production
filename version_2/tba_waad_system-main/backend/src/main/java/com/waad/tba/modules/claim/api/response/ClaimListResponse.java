...
/**
 * ════════════════════════════════════════════════════════════════════════════
 * API v1 Contract: Paginated Claim List Response
 * ════════════════════════════════════════════════════════════════════════════
 * 
 * USAGE:
 ...
 * - GET /api/v1/claims/inbox/approved
...
public class ClaimListResponse {
    ...
    /**
     * List of claim items (READ-ONLY)
     */
    private List<ClaimResponse> items;
    
    /**
     * Total number of claims matching the query (READ-ONLY)
     */
    private Long total;

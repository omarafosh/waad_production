...
public enum ClaimStatus {
    ...
    public Set<ClaimStatus> getValidTransitions() {
        return switch (this) {
            ...
            case APPROVED -> Set.of(BATCHED, SETTLED); // Can go directly to SETTLED (legacy) or to BATCHED (new)
            case BATCHED -> Set.of(SETTLED, APPROVED); // Can settle from batch, or remove from batch back to APPROVED

...
public class ClaimMapper {
    ...
    public Claim toEntity(ClaimCreateDto dto) {
        ...
        // Insurance organization is no longer used in the system
    ...
    public ClaimViewDto toViewDto(Claim claim) {
        ClaimViewDto dto = ClaimViewDto.builder()
                ...
                // Settlement Batch Reference (READ-ONLY)
        ...
        // ═══════════════════════════════════════════════════════════════════════════
        // SETTLEMENT BATCH: Populate batch number if claim has settlementBatchId
        // ═══════════════════════════════════════════════════════════════════════════
        if (claim.getSettlementBatchId() != null) {
            settlementBatchRepository.findById(claim.getSettlementBatchId())
                    .ifPresent(batch -> dto.setSettlementBatchNumber(batch.getBatchNumber()));
        }

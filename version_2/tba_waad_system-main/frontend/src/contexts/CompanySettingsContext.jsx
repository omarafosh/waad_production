...
export function CompanySettingsProvider({ children }) {
   ...
   * Uses PUBLIC endpoint (no auth required) for initial load
   */
  const fetchSettings = useCallback(async () => {
    try {
      ...
      // This allows loading branding on login page before user logs in
      const response = await companyService.getPublicSettings();
      ...
      if (companyData) {
        setSettings({
          ...
          businessType: companyData.businessType || DEFAULT_SETTINGS.businessType,
          businessTypeEn: companyData.businessTypeEn || DEFAULT_SETTINGS.businessTypeEn,

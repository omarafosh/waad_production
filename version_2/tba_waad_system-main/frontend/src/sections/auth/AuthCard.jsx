  ...
  return (
    <MainCard
      sx={{
        ...
        // Conditional Styles
        background: isDarkMode ? 'rgba(15, 29, 50, 0.6)' : alpha(theme.palette.background.paper, 0.9),

        border: isDarkMode ? '1px solid rgba(255, 255, 255, 0.1)' : `1px solid ${theme.palette.divider}`,
        ...
        '&:hover': {
          ...
          boxShadow: isDarkMode ? `0 20px 40px rgba(0, 0, 0, 0.4)` : `0 20px 40px ${alpha(theme.palette.primary.main, 0.15)}`
        },

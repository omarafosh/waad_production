...
export const suppressMUIDeprecationWarnings = () => {
  ...
  console.warn = (...args) => {
    ...
    // B. Suppress MUI Grid deprecations (Only in PROD)
    if (import.meta.env.PROD && (message.includes('MUI: The Grid') || message.includes('deprecated') || message.includes('GridProps'))) {
      return;
    }
